...
suite("Image Extension", () => {
    ...
    test("Image type content", async () => {
        const result = md.render(`:::image type="content" source="../links/media/LSIs.png" alt-text="lsi":::`);
        expect(result).to.equal(`<div class="mx-imgBorder"><p><img src="../links/media/LSIs.png"></p></div>`);
    });
    ...
    test("Image type content - no border", async () => {
        const result = md.render(`:::image type="content" source="../links/media/LSIs.png" border="false" alt-text="lsi":::`);
        expect(result).to.equal(`<img src="../links/media/LSIs.png">`);
    });
