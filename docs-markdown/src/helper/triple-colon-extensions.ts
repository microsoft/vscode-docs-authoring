import { CancellationToken, CompletionContext, CompletionItem, CompletionItemKind, CompletionItemProvider, MarkdownString, Position, Range, SnippetString, TextDocument } from "vscode";
...
*/
export interface ITripleColonExtension {
    readonly content: string;
    readonly extension: string;
}

export type TripleColonExtensions = ITripleColonExtension[];
