...
suite("Image Controller", () => {
    ...
    test("applyIcon", async () => {
        ...
        const filePath = resolve(__dirname, "../../../../../src/test/data/repo/articles/image-controller1.md");
    ...
    test("applyImage", async () => {
        ...
        const filePath = resolve(__dirname, "../../../../../src/test/data/repo/articles/image-controller2.md");
        await loadDocumentAndGetItReady(filePath);
        pickImageType();
        await sleep(400);
    ...
    test("applyComplex", async () => {
        ...
        const filePath = resolve(__dirname, "../../../../../src/test/data/repo/articles/image-controller3.md");
        await loadDocumentAndGetItReady(filePath);
        pickImageType();
        await sleep(400);
        const expectedText = ":::image type=\"complex\" source=\"../images/test.png\" alt-text=\"foo\":::" + os.EOL + os.EOL
            + ":::image-end:::";
        const editor = window.activeTextEditor;
        const actualText = editor?.document.getText();
        assert.equal(expectedText, actualText);
    ...
    test("applyLocScope", async () => {
        ...
        const filePath = resolve(__dirname, "../../../../../src/test/data/repo/articles/image-controller4.md");
        await loadDocumentAndGetItReady(filePath);
        let editor = window.activeTextEditor;
        common.setCursorPosition(editor!, 0, 4);
        pickImageType();
        await sleep(400);
        const expectedText = ":::image type=\"content\" source=\"../images/test.png\" alt-text=\"foo\" loc-scope=\"markdown\":::" + os.EOL;
    ...
    test("applyLightbox", async () => {
        ...
        const filePath = resolve(__dirname, "../../../../../src/test/data/repo/articles/image-controller5.md");
        await loadDocumentAndGetItReady(filePath);
        let editor = window.activeTextEditor;
        common.setCursorPosition(editor!, 0, 4);
        pickImageType();
        await sleep(400);
        const expectedText = ":::image type=\"content\" source=\"../images/test.png\" alt-text=\"foo\" loc-scope=\"markdown\" lightbox=\"../images/test.png\":::" + os.EOL;
        editor = window.activeTextEditor;
        const actualText = editor?.document.getText();
        assert.equal(expectedText, actualText);
        stubShowQuickPick.restore();
