                                                        ...
                                                        <TR>
                                                           <TD style="WIDTH: 480pt; BACKGROUND: white; PADDING-BOTTOM: 0in; PADDING-TOP: 0in; PADDING-LEFT: 0in; PADDING-RIGHT: 0in" vAlign=top width=640>
                                                              <P class=MsoNormal style="mso-line-height-alt: 0pt">
                                                                 <SPAN style='FONT-FAMILY: "Segoe UI",sans-serif; COLOR: black'><IMG id=Picture style="HEIGHT: 1.25in; WIDTH: 6.677in" alt="Developer Relations Content and Learning Coming Soon" src="cid:product-update.png" width=641 height=120></SPAN>
