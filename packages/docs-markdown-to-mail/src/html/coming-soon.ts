export async function generateHtml(emailBodyContent: string, title: string) {
   return `<HTML xmlns="http://www.w3.org/TR/REC-html40" xmlns:v = "urn:schemas-microsoft-com:vml" xmlns:o = "urn:schemas-microsoft-com:office:office" xmlns:w = "urn:schemas-microsoft-com:office:word" xmlns:dt = "uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:m = "http://schemas.microsoft.com/office/2004/12/omml">
<HEAD>
                                    ...
                                    <TBODY>
                                       <TR style="HEIGHT: 984.9pt">
                                          <TD style="HEIGHT: 984.9pt; PADDING-BOTTOM: 0.25in; PADDING-TOP: 15pt; PADDING-LEFT: 0.25in; PADDING-RIGHT: 0.25in" vAlign=top>
                                             <P>
                                                <B>
                                                   <SPAN style='FONT-SIZE: 20pt; FONT-FAMILY: "Segoe UI",sans-serif; COLOR: #2f2f2f'>
                                                      ${title}
                                                      <o:p></o:p>
                                                   </SPAN>
                                                </B>
