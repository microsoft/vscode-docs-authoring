...
const utilities_1 = require("./cleanup/utilities");
const fs_1 = require("fs");
const recursive = require("recursive-readdir");
const telemetryCommand = "unusedImagesAndIncludes";
...
function removeUnusedImagesAndIncludes(workspacePath, progress, resolve) {
