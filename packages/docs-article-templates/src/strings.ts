...
export const validateModuleName = 'Please provide a module name.';
export const enterUnitName = 'Enter unit name';
...
export const displayTemplateList = 'Display template list';
export const newModuleMessage = 'Creating a new module';
export const newUnitMessage = 'Adding unit to existing module';
